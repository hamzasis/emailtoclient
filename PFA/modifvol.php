...
<div><nav style="background-color:whitesmoke">
    ...
    <div class="container">
        <form class="form-group" action="adminvol.php" method="POST">
        <h1 class="text-black text-center" style="padding-top:40px;font-style:italic;">Nouvel vol</h1>    
        <div id="form" style="height:480px" action="insertvol.php" method="POST">
            <div>
        ...
        <div id="first-group" action="insertvol.php" method="POST">
            <form action="adminvol.php" method="POST">
                <label>
                    <h5 style="margin-right: 200px;">Numero de vol</h5>
                </label>
                <input type="text" required="required" name="numv" class="form-control" placeholder="Numero de vol">
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 150px;">Lieu de départ</h5>
                    </label>
                    <input type="text" required="required" name="ldépart" class="form-control" placeholder="Lieu de départ">
                </div>
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 150px;">Date de depart</h5>
                    </label>
                    <input type="date" required="required" placeholder="dd-mm-yyyy" name="depare" class="form-control">
                </div>
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 100px;">Temps de depart</h5>
                    </label>
                    <input type="time" required="required" name="timeD" class="form-control" placeholder="Temps de depart">
                </div>
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 100px;">Nombre des places</h5>
                    </label>
                    <input type="text" required="required" name="nbplace" class="form-control" placeholder="Nombre des places">
                </div>
                </div>
                <div id="second-group">
                <label>
                    <h5 style="margin-right: 200px;">Prix</h5>
                </label>
                <input type="text" required="required" name="Prix" class="form-control" placeholder="Prix">
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 150px;">Lieu d'arrive</h5>
                    </label>
                    <input type="text" required="required" name="larrive" class="form-control" placeholder="Lieu d'arrive">
                </div>
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 150px;">Date d'arrive</h5>
                    </label>
                    <input type="date" required="required" placeholder="dd-mm-yyyy" name="arrive" class="form-control">
                </div>
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 100px;">Temps d'arrive</h5>
                    </label>
                    <input type="time" required="required" name="timeA" class="form-control" placeholder="Temps d'arrive">
                </div>       
                </div>
                <div id="second-group">
