...
<div><nav style="background:whitesmoke">
            ...
            <div class="nav-links" >
                <ul>
                    ...
                    <strong><li><a href="adminvoiture.php"  class="A"  style="font-family: Georgia, serif;">Voiture</a></li></strong>
                    <strong><li><a href="adminhotel.php" style="font-family: Georgia, serif;">Hôtel</a></li></strong>                    
                    <strong><li><a href="adminclient" style="font-family: Georgia, serif;">Admin</a></li></strong>
                    <strong><li><a href="reservation.php" style="font-family: Georgia, serif;">Réservations</a></li></strong>
                    <strong><li style="margin-left:350px;background-color:#1C77E3;border-radius: 5px;"><a href="ajtvoiture.php" style="font-family: Georgia, serif;color:white">Ajouter</a></li></strong>
...
<h2 style="margin-left:450px">Voiture</h2>
</div>
...
<th scope="col" style="border:1px #fff">Description</th>
<th scope="col" style="border:1px #fff">Type</th>
<th scope="col" style="border:1px #fff">Prix</th>
<th scope="col" style="border:1px #fff">Image</th>
...
<td style="border:1px #fff">kia picanto</td>
<td style="border:1px #fff">kia picanto</td>
<td style="border:1px #fff">300</td>
<td style="border:1px #fff"><img src="car1.jpg" alt=""></td>
<td style="border:1px #fff">Entreprise</td>
<td style="border:1px #fff">
<a href="suppvoiture.php" style="margin-left:10px" class="btn btn-primary">Supprimer</a>
<a href="modifvoiture.php" style="margin-left:10px" class="btn btn-primary">Modifier</a>
