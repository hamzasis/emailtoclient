...
<div><nav style="background-color:whitesmoke">
            ...
            <div class="nav-links" >
                <ul>
                    ...
                    <strong><li><a href="adminclient" style="font-family: Georgia, serif;">About</a></li></strong>
    ...
    <div class="container">
        ...
        <div id="form" style="height:320px" action="insertvol.php" method="POST">
            <div>
        ...
        <div id="first-group" action="insertvol.php" method="POST">
            <form action="adminvol.php" method="POST">
                <label>
                    <h5 style="margin-right: 200px;">Description</h5>
                </label>
                <input type="text" required="required" name="description" class="form-control" placeholder="Description">
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 98px;padding-top:10px">Class</h5>
                    </label>
                ...
                <div class="input-grp">
                    <label>
                        <h5 style="margin-right: 150px;">Image</h5>
                    </label>
                    <input type="file" required="required" name="img" class="form-control" placeholder="Lieu d'arrive">
                </div>       
                </div>
                <div id="second-group">
